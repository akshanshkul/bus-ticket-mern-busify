...
function Myticket() {
  ...
  async function getdata(id) {
    try {
      let res = await axios.post("http://127.0.0.1:8000/order/myticket", {
        id,
      });
      // console.log(res);
      setdata(res.data);
  ...
  async function getdataToday() {
    ...
    try {
      let res = await axios.post("http://127.0.0.1:8000/order/myticket/today", {
        id,
      });
  ...
  async function getdataUpcoming() {
    ...
    try {
      let res = await axios.post(
        "http://127.0.0.1:8000/order/myticket/upcoming",
        {
          id,
        }
      );
  ...
  async function getdataPast() {
    let id = Cookies.get("userid");
    try {
      let res = await axios.post("http://127.0.0.1:8000/order/myticket/past", {
        id,
      });
  ...
  async function handledelete(ele) {
    ...
    try {
      let res = await axios.delete(
        `http://127.0.0.1:8000/order/oneorder/:${userid}`
      );
      getdata(userid1);
